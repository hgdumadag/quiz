...
export default function ExamDetail() {
  ...
  // Determine allowed modes from the exam metadata
  const allowedModes = useMemo(() => {
    if (!exam) return [EXAM_MODES.PRACTICE];
    const meta = exam.examMetadata || exam.metadata || {};
    return meta.allowedModes || [EXAM_MODES.PRACTICE];
  }, [exam]);
